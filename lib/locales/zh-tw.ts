export const zhTW = {
  ...
  editor: {
    ...
    stats: {
      ...
      lines: "行數",
      readingTime: "閱讀時間",
      readingTimeLessThanOne: "< 1 分鐘",
      readingTimeMinute: "分鐘",
      readingTimeHour: "小時"
    }
  },
...
<div style="text-align: center; margin-top: 3em; padding: 2em; border-top: 1px solid #eee; color: #666;">
  ...
  toolbar: {
    ...
    focus: "專注",
    focused: "專注中",
    exportMarkdownLabel: "匯出 .md",
    splitView: {
      sideBySide: "並排",
      vertical: "上下",
      switchToSideBySide: "切換為並排檢視",
      switchToVertical: "切換為上下檢視"
    },
    lineOpsActions: {
      duplicate: "複製行",
      delete: "刪除行",
  ...
  dialogs: {
    ...
    focusMode: {
      ...
      activeHint: "專注模式已啟用 - 按 Esc 退出"
    },
    markdownExport: {
      title: "匯出 Markdown",
      description: "將 Markdown 下載為 .md 檔或複製到剪貼簿",
      filenameLabel: "檔名",
      filenamePlaceholder: "document",
      filenameHint: "檔案將保存為 \"{filename}\"",
      download: "下載 .md",
      copy: "複製到剪貼簿",
      fileInfoTitle: "檔案資訊："
    },
